...
/* The nested function can access the other functions/objects/methods within the same scope.
...
const cuBoy = new CubeMaker({
  side: 5
});
console.log(cuBoy.cubeVolume()); 
console.log(cuBoy.cubeSurfaceArea());
